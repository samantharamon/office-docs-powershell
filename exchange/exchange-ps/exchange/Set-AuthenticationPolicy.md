...
- To allow legacy Exchange tokens to be issued, use this switch without a value.
- To block legacy Exchange tokens from being issued, use this exact syntax: `-AllowLegacyExchangeTokens:$false`.
